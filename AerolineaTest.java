...
public class AerolineaTest {
	...
	public void ej14_totalRecaudado_venderSoloUnVueloPrivado_OK() {
	    ...
	    System.out.println(aerolinea.totalRecaudado("Bariloche"));
...
//	    System.out.println(aerolinea.totalRecaudado("Barajas"));
	...
	public void ej15_detalleVuelo_OK() {	
	    ...
	    String esperadoPrivado = String.format("1-PRI - Aeroparque - Bariloche - 07/01/2025 - PRIVADO (1)", codVueloPrivado);
//	    System.out.println(aerolinea.detalleDeVuelo(codVueloPrivado));
